...
scripts=(scripts/test-capability.lua scripts/test-winlock.lua scripts/test-raster.lua scripts/test-pack.lua scripts/test-tree.lua scripts/test-root.lua scripts/test-truncate.lua scripts/test-kitty.lua scripts/test-bufferline-adapter.lua)
fail=0
for s in "${scripts[@]}"; do
