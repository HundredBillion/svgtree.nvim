...
assert(capability.supported_cached(), 'Ghostty must enable terminal image rendering')
tree.open(root)
...
print('Ghostty initial launch, icons, file selection, and Ctrl navigation ok')
